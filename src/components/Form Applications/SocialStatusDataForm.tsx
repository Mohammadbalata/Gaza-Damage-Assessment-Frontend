...
const SocialStatusDataForm: React.FC<{ onSuccess?: () => void }> = ({ onSuccess }) => {
  ...
  const employmentStatuses = [
    ...
    { value: "unemployed", label: language === "ar" ? "عاطل عن العمل" : "Unemployed" },
  ...
  const housingTypes = [
    ...
    { value: "shelter", label: language === "ar" ? "مركز إيواء" : "Shelter Center" },
  ];
        ...
        >
          ...
          <Box>
            <TextField
              fullWidth
              type="number"
              label={language === "ar" ? "عدد المعالين" : "Number of Dependents"}
              {...register("numberOfDependents", { required: t("common.required"), min: 0 })}
          ...
          <Box>
            <TextField
              ...
              {...register("employmentStatus", { required: t("common.required") })}
              error={!!errors.employmentStatus}
            >
              <MenuItem value="" disabled>
                {language === "ar" ? "اختر الحالة العملية" : "Select Employment Status"}
              </MenuItem>
          ...
          <Box>
            <TextField
              fullWidth
              label={language === "ar" ? "الدخل الشهري التقريبي ($)" : "Approx. Monthly Income ($)"}
