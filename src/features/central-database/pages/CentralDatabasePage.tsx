...
import EducationDataForm from "../components/forms/EducationDataForm";
import HealthDataForm from "../components/forms/HealthDataForm";
import ReliefDataForm from "../components/forms/ReliefDataForm";
import SocialStatusDataForm from "../components/forms/SocialStatusDataForm";
  ...
  const modules = [
    {
      ...
      description:
        language === "ar"
          ? "قاعدة بيانات الطلاب، المستويات التعليمية، والاحتياجات الأكاديمية"
          : "Students database, educational levels, and academic needs",
      icon: <EducationIcon sx={{ fontSize: 40 }} />,
      color: "#1976d2",
      component: (
        <EducationDataForm onSuccess={() => setSelectedModule(null)} />
      ),
    },
    {
      id: "health",
      ...
      description:
        language === "ar"
          ? "المعلومات الطبية، الأمراض المزمنة، والاحتياجات الصحية"
          : "Medical information, chronic diseases, and health needs",
    ...
    },
    {
      ...
      description:
        language === "ar"
          ? "الاحتياجات الإغاثية، حالة السكن، والمساعدات"
          : "Relief needs, housing status, and aid",
    ...
    },
    {
      ...
      description:
        language === "ar"
          ? "بيانات الأسرة، الحالة الاجتماعية، والدخل"
          : "Family data, social status, and income",
      icon: <SocialIcon sx={{ fontSize: 40 }} />,
      color: "#ed6c02",
      component: (
        <SocialStatusDataForm onSuccess={() => setSelectedModule(null)} />
      ),
    },
  ];
          ...
          >
            <CardContent sx={{ p: 3 }}>
              <Stack direction="row" spacing={3} alignItems="center">
                ...
                <IconButton sx={{ color: module.color }}>
                  <ArrowBack
                    sx={{
      ...
      >
        ...
        >
          <Stack direction="row" spacing={1} alignItems="center">
            {currentModule?.icon &&
              React.cloneElement(currentModule.icon as React.ReactElement, {
                sx: { fontSize: 24, color: currentModule.color },
              })}
        ...
        <Divider />
        <DialogContent sx={{ p: 3 }}>{currentModule?.component}</DialogContent>
      </Dialog>
