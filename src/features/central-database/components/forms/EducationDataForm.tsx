...
const EducationDataForm: React.FC<{ onSuccess?: () => void }> = ({
  onSuccess,
}) => {
        ...
        >
          ...
          <Box sx={{ gridColumn: { xs: "1 / -1", md: "span 1" } }}>
            <SingleImageInput
              ...
              label={
                language === "ar" ? "صورة الشهادة العلمية" : "Certificate Image"
              }
            />
          </Box>
