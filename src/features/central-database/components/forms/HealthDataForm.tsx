...
const HealthDataForm: React.FC<{ onSuccess?: () => void }> = ({
  onSuccess,
}) => {
            ...
            {hasHealthInsurance && (
              <Box>
                <TextField
                  fullWidth
                  label={
                    language === "ar" ? "جهة التأمين" : "Insurance Provider"
                  }
                  {...register("insuranceProvider", {
                    required: hasHealthInsurance,
                  })}
