export const translations: Record<"en" | "ar", Record<string, string>> = {
  en: {
    ...
    "citizen.viewDetailsComplaint": "View Details",
    "citizen.viewDetailsObjection": "View Details",
    ...
    "citizen.addCurrentLocation": "Add Current Location",
    ...
    // Complaints
    "complaint.add": "Add a complaint or objection about the application",
    ...
    "complaint.objectionDescription": "Objection Description",
    "complaint.descriptionPlaceholder":
      "Please describe your complaint in detail...",
    "complaint.objectionDescriptionPlaceholder":
      "Please describe your objection in detail...",
    ...
    "complaint.objectionDetails": "Objection Details",
    "complaint.status": "Complaint Status",
    "complaint.objectionStatus": "Objection Status",
    ...
    "complaint.closeObjectionError": "Failed to close objection",
  ...
  ar: {
    ...
    // Complaints
    "complaint.add": "اضافة شكوى أو اعتراض على الطلب",
    "complaint.title": "الشكاوى",
    "complaint.myComplaints": "الملاحظات والشكاوي",
    "complaint.myComplaintsAndObjections": "الملاحظات، الشكاوي والاعتراضات",
    "complaint.validation.descriptionMinLength":
      "يجب أن يكون حقل الوصف 10 أحرف على الأقل.",
    "complaint.description": "وصف الشكوى",
    "complaint.objectionDescription": "وصف الاعتراض",
    "complaint.descriptionPlaceholder": "يرجى وصف شكواك بالتفصيل...",
    "complaint.objectionDescriptionPlaceholder": "يرجى وصف اعتراضك بالتفصيل...",
    ...
    "complaint.objectionDetails": "تفاصيل الاعتراض",
    "complaint.status": "حالة الشكوى",
    "complaint.objectionStatus": "حالة الاعتراض",
    "complaint.code": "رمز الشكوى",
    "complaint.objectionCode": "رمز الاعتراض",
    "complaint.application": "الطلب المرتبط",
    "complaint.noComplaints": "ليس لديك شكاوى بعد",
    "complaint.noComplaintsOrObjections": "ليس لديك شكاوى أو اعتراضات بعد",
    ...
    "complaint.closeComplaint": "إغلاق الشكوى",
    "complaint.closeObjection": "إغلاق الاعتراض",
    "complaint.closeConfirm": "هل أنت متأكد من إغلاق هذه الشكوى؟",
    "complaint.closeObjectionConfirm": "هل أنت متأكد من إغلاق هذا الاعتراض؟",
    "complaint.closeSuccess": "تم إغلاق الشكوى بنجاح",
    "complaint.closeObjectionSuccess": "تم إغلاق الاعتراض بنجاح",
    "complaint.closeError": "فشل في إغلاق الشكوى",
    "complaint.closeObjectionError": "فشل في إغلاق الاعتراض",
    ...
    "complaintType.COMPLAINT": "شكوى",
    "complaintType.OBJECTION": "اعتراض",
    "complaint.objectionSuccess": "تم إرسال الاعتراض بنجاح",
    ...
    "citizen.viewDetailsComplaint": "عرض تفاصيل الشكوى",
    "citizen.viewDetailsObjection": "عرض تفاصيل الاعتراض",
    ...
    "citizen.addCurrentLocation": "إضافة الموقع الحالي",
