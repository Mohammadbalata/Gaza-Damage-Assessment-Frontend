export const translations: Record<'en' | 'ar', Record<string, string>> = {
  en: {
    ...
    'verification.description': 'Please answer the following questions to verify your identity',
  ...
  ar: {
    ...
    'verification.description': 'يرجى الإجابة على الأسئلة التالية للتحقق من هويتك',
