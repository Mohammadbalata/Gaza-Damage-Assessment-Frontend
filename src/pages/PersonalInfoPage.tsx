      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            ...
            <input
              ...
              {...register('fullName', {
                ...
                pattern: { value: /^[a-zA-Z\s\u0600-\u06FF]+$/, message: 'Only letters and spaces allowed' }
              })}
          ...
          <div>
            ...
            <input
              ...
              {...register('dateOfBirth', {
                required: t('common.required'),
                validate: (value) => validateAge(value) || 'Must be 18 years or older'
              })}
              className="input-field"
            />
            {errors.dateOfBirth && (
          ...
          <div className="flex gap-4">
            <button type="button" onClick={() => navigate('/national-id')} className="btn-outline flex-1">
              {t('common.back')}
            </button>
